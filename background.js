...
// Função para calcular a altura com a redução de 2pc
function calcHeight() {
	// Convertendo '2pc' para pixels
	var pcToPx = 16; // 1pc = 16px (tamanho de fonte padrão)
	var heightReductionInPc = 2; // Redução de 2pc
	return window.innerHeight - (heightReductionInPc * pcToPx); // Subtraindo a altura de 2pc em pixels
}

var cnv = document.getElementById("c");
var ctx = cnv.getContext("2d");
var w = cnv.width = window.innerWidth;
var h = cnv.height = calcHeight(); // Ajusta a altura do canvas com a redução de 2pc
