...
// Função para calcular a altura total com 302pc + 40pc
function calcHeight() {
	// Convertendo '302pc' e '40pc' para pixels
	var pcToPx = 16; // 1pc = 16px (tamanho de fonte padrão)
	var totalHeightInPc = 302 + 20; // Somando os 40pc adicionais
	return totalHeightInPc * pcToPx; // Retorna a altura em pixels
}

var cnv = document.getElementById("c");
var ctx = cnv.getContext("2d");
// Definindo a altura do canvas até o valor de 302pc + 40pc
var w = cnv.width = window.innerWidth;
var h = cnv.height = calcHeight(); // Definindo a altura como 302pc + 40pc
...
window.addEventListener('resize', function() {
	...
	h = cnv.height = calcHeight(); // Ajusta a altura no redimensionamento
});
