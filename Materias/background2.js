...
// Função para calcular a altura com 115pc
function calcHeight() {
	// Convertendo '115pc' para pixels
	var pcToPx = 16; // 1pc = 16px (tamanho de fonte padrão)
	var totalHeightInPc = 115; // Altura desejada de 115pc
	return totalHeightInPc * pcToPx; // Retorna a altura em pixels
}

var cnv = document.getElementById("c");
var ctx = cnv.getContext("2d");
// Definindo a altura do canvas até o valor de 115pc
var w = cnv.width = window.innerWidth;
var h = cnv.height = calcHeight(); // Definindo a altura como 115pc
